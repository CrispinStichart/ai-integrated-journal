...
| SEARCH-003–004 | Lexical/semantic/hybrid API, component, and Firefox tests navigate to exact revisions with inert source snippets, retrieval signals, and visible source/generated labels; grounded-answer synthesis remains Tasks 46/51. | 44–46, 51 | Complete local release | Partial |
...
| SEARCH-006 | Transactional trigger/cascade, migration, worker-generation, owner-isolation, and query tests immediately exclude replaced, deleted, stale, partial, superseded, disabled, or unapproved text/vectors; permanent tombstone coverage remains Task 47. | 44–47 | Complete local release | Partial |
