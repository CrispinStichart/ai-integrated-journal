...
| RET-006–007 | Domain/contracts, real-PostgreSQL retention integration, worker retry/idempotency, IndexedDB purge, and browser API tests cover grace, tombstone-first bounded deletion across rows/revisions/blobs/staging/text/vectors/caches/outboxes/raw responses, and anti-resurrection. Tasks 48–49 implement export/backup adapters against the documented tombstone boundary; Task 52 adds migration restore drills. | 47–49, 52 | Complete local release | Partial |
