...
| SEARCH-003–004 | `SEARCH`, `RELEASE-E2E`: lexical results navigate to exact revisions with inert highlighted source snippets and visible source/generated labels; grounded-answer synthesis remains Tasks 46/51. | 44–46, 51 | Complete local release | Partial |
| SEARCH-005 | `SEARCH`: date, contribution, processor, result, entity, authority, and layer filters compose in SQL before deterministic pagination/ranking; hybrid parity remains Task 45. | 44, 45 | Complete local release | Partial |
| SEARCH-006 | `SEARCH`, `RETENTION`: transactional triggers and owner-scoped queries immediately exclude replaced, deleted, stale, superseded, disabled, or unapproved lexical fragments; permanent lifecycle coverage remains Tasks 45–47. | 44–47 | Complete local release | Partial |
