...
| Failure contract | Unsupported input, invalid EBML, numeric overflow, truncated data, and resource-policy violations have stable typed error classes and discriminating codes. Resource policy values and adversarial boundary coverage remain the separately planned Task 5. |
